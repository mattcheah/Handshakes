...
RSpec.describe User, type: :model do
    ...
    it { is_expected.to validate_length_of(:first).is_at_least(1) }
    it { is_expected.to validate_length_of(:first).is_less_than(24) }
    
    it { is_expected.to validate_presence_of(:last) }
    it { is_expected.to validate_length_of(:last).is_at_least(1) }
    it { is_expected.to validate_length_of(:last).is_less_than(24) }
